...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <h2>Apple Tree</h2>
                <p>The apple tree is a deciduous tree in the rose family best known for its sweet, pomaceous fruit, the apple. It is cultivated worldwide and is the most widely grown species in the genus Malus.</p>
            </div>
        </div>
    </div>
</body>
